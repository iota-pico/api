...
*Defined in [models/IGetBalancesRequest.ts:9](https://github.com/iota-pico/api/blob/98be397/src/models/IGetBalancesRequest.ts#L9)*
...
*Defined in [models/IGetBalancesRequest.ts:13](https://github.com/iota-pico/api/blob/98be397/src/models/IGetBalancesRequest.ts#L13)*
